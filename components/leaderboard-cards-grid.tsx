...
interface LeaderboardCardsGridProps {
...
export function LeaderboardCardsGrid({
  indicators,
  leaderboardData,
  leaderboardLoading,
  selectedView,
      ...
      {indicators.map((indicator) => {
        ...
        return (
          <LeaderboardCard
            ...
            indicator={{
              ...indicator,
              unit: getUnitWithNormalization(indicator.unit, normalization, leaderboardType),
            }}
            allData={allData}
